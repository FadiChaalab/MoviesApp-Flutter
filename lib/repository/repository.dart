...
class MovieRepository {
  ...
  Future<ImageResponse> getMovieImages(int id) async {
    var params = {"api_key": apiKey, "language": "en-US"};
    try {
      Response response = await _dio.get(movieUrl + "/$id" + "/images",
          queryParameters: params);
  ...
  Future<MovieResponse> getSearchedMovies(String query) async {
    try {
  ...
  Future<PersonDetailResponse> getPersonDetail(int id) async {
    ...
    try {
      Response response =
          await _dio.get(getPersonUrl + "/$id", queryParameters: params);
