...
import 'package:movies/bloc/get_popular_tv.dart';
...
class BestTvShows extends StatefulWidget {
  @override
  _BestTvShowsState createState() => _BestTvShowsState();
}

class _BestTvShowsState extends State<BestTvShows> {
  @override
  void initState() {
    super.initState();
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<TvShowsResponse>(
          stream: popularTvBloc.subject.stream,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    tv[index].poster == null
                        ? Hero(
                            tag: "popilar_Tv_Icon_" + tv[index].id.toString(),
                            child: Container(
                              width: 120.0,
                              height: 180.0,
                              decoration: new BoxDecoration(
                        ...
                        : Hero(
                            tag: "populairtv_" + tv[index].id.toString(),
                            child: Container(
                              width: 120.0,
                              height: 180.0,
                              decoration: new BoxDecoration(
