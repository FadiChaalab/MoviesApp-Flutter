...
import 'package:movies/bloc/get_tv_popular_now_bloc.dart';
...
class _PopularTvShowsState extends State<PopularTvShows> {
  ...
  void initState() {
    super.initState();
    popularTvShowsBloc..getPopularTv();
  }
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<TvShowsResponse>(
          stream: popularTvShowsBloc.subject.stream,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    tv[index].poster == null
                        ? Hero(
                            tag: "popular_Tv_Icon_" + tv[index].id.toString(),
                            child: Container(
                              width: 120.0,
                              height: 180.0,
                              decoration: new BoxDecoration(
                        ...
                        : Hero(
                            tag: "populartv_" + tv[index].id.toString(),
                            child: Container(
                              width: 120.0,
                              height: 180.0,
                              decoration: new BoxDecoration(
